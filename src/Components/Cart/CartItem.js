  ...
  return (
    <Col xs="12" className="cart-item-body my-2 d-flex px-2">
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body><div className='font'>Are you sure you want to delete the product from the cart?</div></Modal.Body>
        <Modal.Footer>
      ...
      <img width="160px" height="197px" src={item.product ? item.product.imageCover : Avatar} alt="" />
      <div className="w-100">
        ...
        <Row className="justify-content-between">
          <Col sm="12" className=" d-flex flex-row justify-content-between">
            ...
            <div className="d-inline pt-2 barnd-text">{item.price || 0} SAR</div>
          </Col>
        </Row>
      </div>
    </Col>
